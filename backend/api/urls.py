...
router.register(
    r"case-summary/(?P<case_summary_id>\d+)/updates",
    CaseUpdateViewSet,
    basename="case-update-for-case-summary",
)
router.register(
    r"case-summary/(?P<case_summary_id>\d+)/documents",
    DocumentViewSet,
    basename="case-document-for-case-summary",
)
router.register(r"update-role", UserRoleUpdateViewSet, basename="update-role")
router.register(
    r"update-lawyer-type", UserLawyerTypeUpdateViewSet, basename="update-lawyer-type"
)
